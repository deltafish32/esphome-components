...
from . import climate_ir_ex
from esphome.const import CONF_ID

# AUTO_LOAD = ["climate_ir"]

climate_ir_lg_ns = cg.esphome_ns.namespace("climate_ir_lg_ex")
LgIrClimate = climate_ir_lg_ns.class_("LgIrClimate", climate_ir_ex.ClimateIR)
...
CONFIG_SCHEMA = climate_ir_ex.CLIMATE_IR_WITH_RECEIVER_SCHEMA.extend(
    {
...
async def to_code(config):
    ...
    await climate_ir_ex.register_climate_ir(var, config)
