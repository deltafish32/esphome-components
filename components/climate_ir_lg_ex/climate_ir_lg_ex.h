...
class LgIrClimate : public climate_ir_ex::ClimateIR {
 public:
  LgIrClimate()
      : climate_ir_ex::ClimateIR(TEMP_MIN, TEMP_MAX, 1.0f, true, true,
  ...
  void control(const climate::ClimateCall &call) override {
    ...
    climate_ir_ex::ClimateIR::control(call);
  }
